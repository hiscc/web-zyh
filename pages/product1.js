...
export default function Home() {
  const Style = (
    <style jsx global>{`
      .bg1 {
        background: url('/static/product1/b1.png') no-repeat center,
      ...
      <Block w="100%" bg="black" flex className={styles.b1}>
        <Block padding={[80, 0]} wmax={1200} w="100%" margin={[0, 'auto']}>
          <Block flex column>
            <Block flex row>
              <Block w={40} h={36}>
                <ExportedImage src="/static/product1/i1.png" layout="fill" />
              </Block>
          ...
          <Block flex margin={[80, 0, 0]}>
            <Block w={187} h={205} wmin={187} className={styles.img}>
              <ExportedImage src="/static/product1/m1.png" layout="fill" />
            </Block>
            <Block flex margin={[0, 0, 0, 100]} className={styles.item}>
              ...
              >
                <ExportedImage src="/static/product1/f1.png" layout="fill" objectFit="cover" />
              </Block>
      ...
      <Block w="100%" bg="black" flex className={styles.b2}>
        <Block padding={[80, 0]} wmax={1200} w="100%" margin={[0, 'auto']}>
          <Block flex column>
            <Block flex row>
              <Block w={40} h={36}>
                <ExportedImage src="/static/product1/i2.png" layout="fill" />
              </Block>
              <Block margin={[-8, 0, 0, 20]}>
          ...
          <Block flex margin={[80, 0, 0]}>
            <Block w={187} h={205} wmin={187} className={styles.img}>
              <ExportedImage src="/static/product1/m2.png" layout="fill" />
            </Block>
            <Block flex margin={[0, 0, 0, 100]} className={styles.item}>
              <Block
                w="100%"
                ...
                style={{ position: 'absolute', top: -50, left: -50, right: 50, bottom: 50, overflow: 'auto' }}
              >
                <ExportedImage src="/static/product1/f2.png" layout="fill" objectFit="cover" />
              </Block>
              <Block padding={[32, 40]} bg="#FFF6F6" radius={14}>
      ...
      <Block w="100%" bg="black" flex className={styles.b3}>
        <Block padding={[80, 0]} wmax={1200} w="100%" margin={[0, 'auto']}>
          <Block flex column>
            <Block flex row>
              <Block w={40} h={36}>
                <ExportedImage src="/static/product1/i3.png" layout="fill" />
              </Block>
              <Block margin={[-8, 0, 0, 20]}>
          ...
          <Block flex margin={[80, 0, 0]}>
            <Block w={187} h={205} wmin={187} className={styles.img}>
              <ExportedImage src="/static/product1/m3.png" layout="fill" />
            </Block>
            <Block flex margin={[0, 0, 0, 100]} className={styles.item}>
              <Block
                w="100%"
                ...
                style={{ position: 'absolute', top: -50, left: -50, right: 50, bottom: 50, overflow: 'auto' }}
              >
                <ExportedImage src="/static/product1/f3.png" layout="fill" objectFit="cover" />
              </Block>
              <Block padding={[32, 40]} bg="#FFF6F6" radius={14}>
                <Block s={20} className="title-with-line" flex center middle>
                  <Block w={60} h={1} bg="#FFA517" />
      ...
      <Block w="100%" bg="black" flex className={styles.b4}>
        <Block padding={[80, 0]} wmax={1200} w="100%" margin={[0, 'auto']}>
          <Block flex column>
            <Block flex row>
              <Block w={40} h={36}>
                <ExportedImage src="/static/product1/i4.png" layout="fill" />
              </Block>
              <Block margin={[-8, 0, 0, 20]}>
          ...
          <Block flex margin={[80, 0, 0]}>
            <Block w={187} h={205} wmin={187} className={styles.img}>
              <ExportedImage src="/static/product1/m4.png" layout="fill" />
            </Block>
            <Block flex margin={[0, 0, 0, 100]} className={styles.item}>
              <Block
                w="100%"
                ...
                style={{ position: 'absolute', top: -50, left: -50, right: 50, bottom: 50, overflow: 'auto' }}
              >
                <ExportedImage src="/static/product1/f4.png" layout="fill" objectFit="cover" />
              </Block>
              <Block padding={[32, 40]} bg="#FFF6F6" radius={14}>
                <Block s={20} margin={[4, 0]}>
                  当前存在的主要问题
