 ...
 * @LastEditTime: 2022-06-23 16:37:53
 * @Description:
...
export default function Home() {
  return (
    <Block w="100%" bg="#000000" color="#FFFFFF" padding={[0, 0, 100]}>
      <Block flex w="100%" h={800} className={styles.banner}>
        <ExportedImage src="/home/banner.png" objectFit="cover" layout="fill" />
      </Block>

      <Block className={styles.f1} margin={[0, 'auto']} flex padding={[100, 0, 0]} w="100%" h={1200}>
        <Block margin={[60, 30, 0, 300]}>
          <Block w={316} h={106}>
            <ExportedImage src="/home/i1.png" objectFit="cover" layout="fill" />
          </Block>
          <Block margin={[24, 0]}>
          ...
          <Block w={357} h={118}>
            <ExportedImage src="/home/f1-2.png" objectFit="cover" layout="fill" />
          </Block>
        </Block>
      </Block>

      <Block className={styles.f2} margin={[0, 'auto', 0]} flex padding={[100, 0, 0]} w="100%" h={900}>
        <Block margin={[60, 30, 0, 300]}>
          <Block w={766} h={106}>
            <ExportedImage src="/home/i2.png" objectFit="cover" layout="fill" />
          </Block>
      ...
      <Block className={styles.f3} margin={[0, 'auto', 0]} flex padding={[100, 0, 0]} w="100%" h={900}>
        <Block margin={[60, 30, 0, 300]}>
          <Block w={291} h={106}>
            <ExportedImage src="/home/i3.png" objectFit="cover" layout="fill" />
          </Block>
          <Block
            lineHeight={31}
            className={styles.f3Body}
            margin={[120, 0, 0]}
            wmax={1360}
            padding={70}
            bg="#AB1E23"
          ...
          >
            ...
            <Block w="60%" h={480} bg="yellow" style={{ right: '-10%', top: -200 }}>
              <ExportedImage src="/home/f3-1.png" objectFit="cover" layout="fill" />
            </Block>
          </Block>
        </Block>
      </Block>

      <Block className={styles.f4} margin={[0, 'auto', 0]} padding={[100, 0, 0]} w="100%" h={1050}>
        <Block margin={[60, 30, 0, 300]}>
          <Block w={420} h={106}>
            <ExportedImage src="/home/i4.png" objectFit="cover" layout="fill" />
          </Block>
          <Block flex wrap margin={[54, -20]} className={styles.f4Card} space="between">
            {[1, 2, 3, 4].map((icon) => {
              return (
                <Block key={icon} flex={1} w="45%" margin={[20]} h={260} border borderColor="#EBEBEB">
                  <ExportedImage src={`/home/f4-${icon}.png`} objectFit="cover" layout="fill" />
                </Block>
              )
            })}
          </Block>
