 ...
 * @LastEditTime: 2022-06-21 15:50:59
 * @Description: 
    ...
    <Block  bg='#282828' h={460}>
      <Block wmax='1200px' w='100%' color='#FFFFFF' flex  margin={[0, 'auto']} padding={[77,0]} space='between'>
        ...
        <Block flex column>
          ...
          <Block margin={[10,0,0,0]}>
            {['业务范围', '通用税筹方案', '定制税筹方案', '企业简介', '合作伙伴', '新闻展示'].map(link => {
              return <Block key={link} margin={[12,0]} color='#999999'>{link}</Block>
            })}
          </Block>
        </Block>
        ...
        <Block flex column>
          <Block >产品与服务</Block>
          <Block margin={[10,0,0,0]}>
            {['ETC电子发票数据服务', '撮合交易司机专票代开服务', '普通货物网络货运服务', '土石方专业网络货运服务'].map(link => {
              return <Block key={link} margin={[12,0]} color='#999999'>{link}</Block>
            })}
          </Block>
        </Block>
        ...
        <Block flex column>
            ...
            <Block flex row>
              <Block w={20} h={20} margin={[0,10,0,0]}><Image  src="/about/phone.png"  layout='fill'/></Block>
              <Block>
                <Block >客户服务热线 7*12小时</Block>
                <Block  s={24} color='#E11A22' margin={[8,0,0]}>133 6708 9060</Block>
              </Block>
            </Block>

            <Block flex row margin={[20,0, 0]}>
              <Block w={20} h={20} margin={[0,10,0,0]}><Image  src="/about/email-white.png"  layout='fill'/></Block>
              <Block>
            ...
            <Block flex column margin={[20,0]} middle center>
              <Block fixed={100} margin={[0,10,0,0]}><Image  src="/about/kehurexian.png"  layout='fill'/></Block>
              <Block color='#999999' margin={[7,0,0]}>关注我们</Block>
            </Block>
